...
class _HomePageState extends State<HomePagea> {
  // All data
  ...
  void showMyForm(int? id) async {
    if (id != null) {
      ...
      _dateController.text=existingData['time'];
    }
...
// Insert a new data to the database
  Future<void> addItem() async {
    await DatabaseHelper.createItem(
        _titleController.text, _descriptionController.text, _dateController.text);
    _refreshData();
  }
